...
The main page shows all the different parts of the project. Here we can see the available list of meals that users can order from. Each meal has name, description and price. So that users can add the meals to the cart by simply filling the form by entering the amount they want and click on the add button. 
